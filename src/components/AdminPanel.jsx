...
export default function AdminPanel() {
  ...
  useEffect(() => { setLocalEditing(editingProject); }, [editingProject]);
  useEffect(() => {
  ...
  const handleSelect   = (p) => setLocalEditing(p);
  const handleNew      = () => setLocalEditing(null);
                ...
                {isAdmin && (
                  <>
                    ...
                    <button
                      ...
                      onClick={() => {
                        const content = `// Auto-generated by Museum Editor — paste into src/data/projects.js\nexport const INITIAL_PROJECTS = ${JSON.stringify(projects, null, 2)};\n`;
